...
City.create({name: "Seattle", image: "https://cdn-payscale.com/content/wikipedia/commons/2/2f/Space_Needle002.jpg"})
...
City.create({name: "Tokyo", image: "https://www.omm.com/~/media/images/site/locations/tokyo_780x520px.ashx"})
